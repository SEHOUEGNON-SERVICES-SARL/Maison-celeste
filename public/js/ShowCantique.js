document.addEventListener('DOMContentLoaded', async function() {
    try {
      const response = await axios.get('https://maison-celeste.onrender.com/api/allcantiques');
      ...
      cantiques.forEach(cantique => {
        ...
        audioPlayer.innerHTML = `<source src="https://maison-celeste.onrender.com/api/firebase/${cantique.audio_path}" type="audio/mpeg">
